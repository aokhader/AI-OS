...
Must not depend on Playwright, the Anthropic SDK, Fastify or anything else runtime-specific. Only zod and Node built-ins. The replay engine can reach a model only through the optional `RecoveryPlanner` port. See `docs/context/01-architecture.md` §3.
